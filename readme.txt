...
Tags: seo,widget,google,search
Requires at least: 2.6
Tested up to: 2.8.6
Stable tag: 1.9.4.1

Dynamic on-site SEO for your WordPress blog.
...
5. Go to your "Widgets" section under "Appearance" and look for and include the widget where you want to add it
